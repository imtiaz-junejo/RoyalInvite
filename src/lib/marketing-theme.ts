...
export const mt = {
  page: "min-h-screen bg-white font-sans text-neutral-900",
  ...
  pageBelowFold: "border-t border-neutral-100",
  ...
  headingSm: type.h2,
  headingCard: type.h4,
  subheading: `${type.secondary} text-neutral-600`,
  body: type.body,
  muted: type.muted,
  link: type.link,
  linkInline: type.linkInline,

  card: "overflow-hidden rounded-xl border border-neutral-200/80 bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-md hover:shadow-neutral-900/8",
  cardBody: "p-4",
  cardStatic: "rounded-xl border border-neutral-200/80 bg-white p-5 shadow-sm",
  cardStaticCompact: "rounded-xl border border-neutral-200/80 bg-white p-4 shadow-sm",
  ...
  secondaryBtn: `inline-flex items-center justify-center rounded-full border border-neutral-300 bg-white px-5 py-2.5 ${type.btn} text-neutral-800 shadow-sm transition hover:border-neutral-400 hover:bg-neutral-50`,
  promo: type.promo,
  promoLg: type.promoLg,
  promoSub: type.promoSub,

  badgeFree: `rounded-full bg-neutral-900/85 px-2 py-0.5 ${type.badge} text-white`,
  ...
  authPage:
    "flex min-h-[calc(100svh-var(--site-nav-height))] items-center justify-center bg-neutral-50 px-4 py-8 sm:px-6",
  authCard:
    "w-full max-w-md rounded-xl border border-neutral-200/80 bg-white p-6 shadow-lg shadow-neutral-900/5 sm:p-7",
  errorAlert: `rounded-lg border border-red-200 bg-red-50 px-3 py-2.5 ${type.error}`,
} as const
